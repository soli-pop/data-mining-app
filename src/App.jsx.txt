        ...
        <div style={{ overflow:"hidden", maxHeight:expanded?"500px":"0", transition:"max-height .35s cubic-bezier(0.4,0,0.2,1)" }}>
          <div style={{ borderTop:"1.5px solid #e8edf5", padding:"12px 14px 14px", background:"#f8fafc" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:7, marginBottom:10 }}>
              {[
                ...(row.profession ? [{ lbl:"Profession", raw:row.profession, badge:row.profession, color:"#475569" }] : []),
...
const DesktopRow = ({ row, isLast, isGuest, onEdit, onDelete, idx }) => {
  ...
  return (
    <div
      ...
      style={{
        display:"grid",
        gridTemplateColumns:"minmax(140px,2fr) 80px 130px 110px 130px 120px 140px",
        alignItems:"center",
        padding:"14px 16px",
    ...
    >
      {/* Name + profession pill */}
      <div style={{ minWidth:0 }}>
        <div style={{ fontWeight:700, fontSize:"0.9rem", color:"#0f172a", overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap", marginBottom:5 }}>
          {row.name || "—"}
        </div>
        {(row.profession || catL) && (
          <Badge label={row.profession || catL} color={row.profession ? "#64748b" : CAT_C[catL]||"#6366f1"} size="xs"/>
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:5, alignItems:"flex-end" }}>
        <button
          onClick={() => onEdit(row)}
          style={{ display:"flex", alignItems:"center", gap:4, padding:"6px 14px", borderRadius:7, border:"1.5px solid #bfdbfe", background:"#eff6ff", color:"#1d4ed8", fontWeight:600, fontSize:"0.74rem", cursor:"pointer", fontFamily:"inherit", whiteSpace:"nowrap", width:"100%" }}
        ...
        {!isGuest && (
          <button
            ...
            style={{ display:"flex", alignItems:"center", gap:4, padding:"6px 14px", borderRadius:7, border:"1.5px solid #fecaca", background:"#fff7f7", color:"#dc2626", fontWeight:600, fontSize:"0.74rem", cursor:"pointer", fontFamily:"inherit", whiteSpace:"nowrap", width:"100%" }}
            ...
            {tab==="table" ? (
              <>
                ...
                <div style={{ background:"#fff", borderRadius:16, boxShadow:"0 2px 10px rgba(0,0,0,0.07)", overflow:"hidden", marginBottom:14, border:"1.5px solid #d1d9e6" }}>
                  ...
                  <div style={{ minWidth: wide ? 940 : "auto" }}>
                  {/* Header */}
                  <div style={{ display:"grid", gridTemplateColumns:wide?"minmax(140px,2fr) 80px 130px 110px 130px 120px 140px":"minmax(0,2fr) minmax(0,1.5fr) minmax(0,1.2fr) 22px", gap:wide?8:8, padding:wide?"11px 16px":"10px 14px", background:"#eef1f7", borderBottom:"2px solid #d1d9e6" }}>
                    {(wide
                      ? [
                          {h:"Name",       s:"Profession"},
                          {h:"Age",        s:"Label"},
