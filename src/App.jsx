...
const DesktopRow = ({ row, isLast, isGuest, onEdit, onDelete, idx }) => {
  ...
  return (
    <div
      ...
      style={{
        display:"grid",
        gridTemplateColumns:"minmax(0,1.8fr) 80px 130px 120px 130px 130px 110px",
        alignItems:"center",
        padding:"14px 18px",
            ...
            {tab==="table" ? (
              <>
                ...
                <div style={{ background:"#fff", borderRadius:16, boxShadow:"0 2px 10px rgba(0,0,0,0.07)", overflow:"hidden", marginBottom:14, border:"1.5px solid #d1d9e6" }}>
                  {/* Header */}
                  <div style={{ display:"grid", gridTemplateColumns:wide?"minmax(0,1.8fr) 80px 130px 120px 130px 130px 110px":"minmax(0,2fr) minmax(0,1.5fr) minmax(0,1.2fr) 22px", gap:wide?10:8, padding:wide?"11px 18px":"10px 14px", background:"#eef1f7", borderBottom:"2px solid #d1d9e6" }}>
                    {(wide
                      ? [
