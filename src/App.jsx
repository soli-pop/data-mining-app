...
// ─── Avatar Picker Sheet ──────────────────────────────────────────────────────
const AvatarSheet = ({ open, onClose, onPick, hasPhoto, onRemove }) => {
      ...
      <div onClick={e=>e.stopPropagation()} style={{ width:"100%", maxWidth:420, background:"#fff", borderRadius:"22px 22px 0 0", padding:"8px 0 28px", boxShadow:"0 -8px 40px rgba(0,0,0,0.18)", animation:"slideUp .25s cubic-bezier(0.34,1.1,0.64,1)" }}>
        ...
        {[
          ...
          <button key={opt.label} onClick={opt.action}
            style={{ width:"100%", display:"flex", alignItems:"center", gap:16, padding:"14px 24px", border:"none", background:"transparent", cursor:"pointer", fontFamily:"inherit", textAlign:"left" }}
...
const Sidebar = ({ user, tab, setTab, onLogoutClick, wide, menuOpen, onClose }) => {
  ...
  const body = (
    <div style={{ display:"flex", flexDirection:"column", height:"100%" }}>
      <AvatarSheet open={avatarSheet} onClose={()=>setAvatarSheet(false)} onPick={saveAvatar} hasPhoto={!!avatar} onRemove={removeAvatar}/>
              ...
              <>
                ...
                <div style={{ background:"#fff", borderRadius:16, boxShadow:"0 2px 10px rgba(0,0,0,0.07)", overflow:"hidden", marginBottom:14, border:"1.5px solid #d1d9e6" }}>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:wide?"minmax(140px,2fr) 90px 130px 120px 130px 120px 150px":"minmax(0,2fr) minmax(0,1.5fr) minmax(0,1.2fr) 22px", gap:wide?8:8, padding:wide?"11px 16px":"10px 14px", background:"#eef1f7", borderBottom:"2px solid #d1d9e6" }}>
                    {(wide
                      ? [
                          {h:"Subject",           s:"Occupation Class"},
                          {h:"Demographic",       s:"Life Stage"},
                          {h:"Financial Bracket", s:"Income Tier"},
                          {h:"Acquisition",       s:"Product Class"},
                          {h:"Expenditure",       s:"Spend Tier"},
                          {h:"Origin",            s:"Geographic Zone"},
                          {h:"Actions",           s:""},
                        ]
                      : [
                          {h:"Subject",    s:"Occupation"},
                          {h:"Life Stage", s:"Fin. Bracket"},
                          {h:"Spend Tier", s:"Region"},
                          {h:"",           s:""},
                        ]
                    ).map((c,i)=>(
